...
func (_mock *MockGenerator) Generate(m *maze.Maze) {
	_mock.Called(m)
	return
}
...
//   - m *maze.Maze
func (_e *MockGenerator_Expecter) Generate(m interface{}) *MockGenerator_Generate_Call {
	return &MockGenerator_Generate_Call{Call: _e.mock.On("Generate", m)}
}

func (_c *MockGenerator_Generate_Call) Run(run func(m *maze.Maze)) *MockGenerator_Generate_Call {
...
func (_c *MockGenerator_Generate_Call) Return() *MockGenerator_Generate_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockGenerator_Generate_Call) RunAndReturn(run func(m *maze.Maze)) *MockGenerator_Generate_Call {
	_c.Run(run)
	return _c
}
